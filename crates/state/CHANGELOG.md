...
## [42.0.1](https://github.com/4waan/revm/compare/revm-state-v42.0.0...revm-state-v42.0.1) - 2026-08-19

### Fixed

- *(state)* align Account's manual Deserialize field order with derived Serialize ([#3870](https://github.com/4waan/revm/pull/3870))
