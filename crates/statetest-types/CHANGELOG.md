...
## [42.0.1](https://github.com/4waan/revm/compare/revm-statetest-types-v42.0.0...revm-statetest-types-v42.0.1) - 2026-08-17

### Other

- updated the following local packages: revm-primitives, revm-context-interface, revm-context, revm-database, revm-state
