...
## [42.0.1](https://github.com/4waan/revm/compare/revm-database-v42.0.0...revm-database-v42.0.1) - 2026-08-17

### Fixed

- *(database)* cache newly created contract code ([#3855](https://github.com/4waan/revm/pull/3855))
