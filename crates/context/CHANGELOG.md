...
## [43.0.0](https://github.com/4waan/revm/compare/revm-context-v42.0.0...revm-context-v43.0.0) - 2026-08-19

### Added

- *(journal)* finalize selfdestructed accounts in place from Cancun ([#3863](https://github.com/4waan/revm/pull/3863))
- glamsterdam devnet-8 gas repricing ([#3850](https://github.com/4waan/revm/pull/3850))
- add async database fiber support ([#3709](https://github.com/4waan/revm/pull/3709))

### Fixed

- check call depth in CREATE pre-access checks (EIP-8037) ([#3829](https://github.com/4waan/revm/pull/3829))

### Other

- remove duplicate Amsterdam gas overrides and dead CPSB constants ([#3857](https://github.com/4waan/revm/pull/3857))
